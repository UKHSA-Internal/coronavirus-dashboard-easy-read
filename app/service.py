...
# Internal:
from app.easy_read.views import easy_read, local_easy_read
...
@app.route("/easy_read", methods=("OPTIONS", "GET"))
...
@app.route("/easy_read/<area_type>/<area_code>", methods=("OPTIONS", "GET"))
def local_responder(area_type, area_code, **kwargs):
    if request.method == "GET":
        return local_easy_read(area_type, area_code)
